...
import { FlatList, ImageBackground, Pressable, ScrollView, StyleSheet, Text, View, type ImageStyle, type TextStyle, type ViewStyle } from 'react-native';
...
export function PostsScreen() {
    ...
    const heroFallback = useMemo(() => {
        const ordered = [...storagePosts].sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime());
        return ordered[0];
    }, []);
